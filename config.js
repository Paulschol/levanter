...
module.exports = {
  ...
  SESSION_ID: (process.env.SESSION_ID || 'levanter_9fc448847b8364c1ea8f1ac99b220ddb9').trim(),
  DATABASE:
  ...
  PERSONAL_MESSAGE: (process.env.PERSONAL_MESSAGE || 'Hello 👋 This is Anonymous Dave's bot 🤖; my boss is not online he will message you as soon as possible ❌⭕❌⭕').trim(),
  ...
  TRUECALLER: process.env.TRUECALLER,'true'
